...
const emit = defineEmits<{
  close: []
  submit: [payload: NewAppointmentInput]
}>()
...
<template>
  ...
  >
    <div class="dialog" role="dialog" aria-modal="true" aria-labelledby="cad-title">
      <h3 id="cad-title" class="dialog__title">Termin anlegen</h3>

      <form class="dialog__form" @submit.prevent="onSubmit">
        <label class="dialog__field">
          <span class="dialog__label">Titel</span>
          <input ref="titleRef" v-model="title" class="dialog__input" type="text" placeholder="z. B. Team-Meeting" />
        </label>
