-- Erweitert get_team_free_slots um persönliche Termine aller Team-Mitglieder.
-- Persönliche Termine werden als belegte Zeiträume behandelt, genau wie
-- Stundenplan-Slots (user_events) und Team-Termine (team_appointments).
    ...
    FOR rec IN
      ...
      FROM (
        ...
        FROM (
          ...
          -- Persönliche Termine aller Team-Mitglieder
