-- ============================================================
-- In-App-Benachrichtigungen für Termine & Einladungs-Antworten.
-- Konsistent mit dem in-app, datensatzbasierten Muster der
-- "Team einladen"-Story (keine E-Mail-Infrastruktur vorhanden).
--
--   * Termin-Erstellung -> Benachrichtigung an alle eingeladenen
--     Mitglieder (außer dem Ersteller).
--   * Einladungs-Antwort (accept/decline) -> Benachrichtigung an den
--     Ersteller.
--
-- Idempotenz: jede Benachrichtigung hat einen eindeutigen dedup_key;
-- Inserts laufen mit ON CONFLICT (dedup_key) DO NOTHING -> keine
-- Duplikate bei Retries. Templates enthalten Titel, Zeit und Team.
-- ============================================================
...
-- Nutzer sehen/ändern nur die eigenen Benachrichtigungen.
...
-- ------------------------------------------------------------
-- create_team_appointment: + Benachrichtigungen an eingeladene Mitglieder
-- ------------------------------------------------------------
...
-- ------------------------------------------------------------
-- respond_to_appointment_invitation: + Benachrichtigung an Ersteller
-- ------------------------------------------------------------
